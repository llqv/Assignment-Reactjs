        ...
        return (
          ...
          */}
                            ...
                            <div className="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
                                ...
                                <Link to="/auth/signup" className="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700">Sign up</Link>
                            </div>
                        </div>
                    </div>
                    {/*
